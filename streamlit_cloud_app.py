    ...
    with tab2:
        ...
        with st.form("add_patient_form"):
            ...
            with col2:
                ...
                # Set min_value to 100 years ago and max_value to today
                dob = st.date_input("Date of Birth", value=None, min_value=date.today() - timedelta(days=36500), max_value=date.today())

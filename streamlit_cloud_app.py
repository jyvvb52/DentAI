...
def questionnaire_page():
    ...
    with tabs[6]:
        ...
        try:
            # Ensure we have an open database connection for this tab
            if conn.total_changes < 0:  # This is just to check if conn is closed
                conn = sqlite3.connect('data/dentai.db')
                c = conn.cursor()
        ...
        # Don't close the connection here - it will be closed at the end of the function

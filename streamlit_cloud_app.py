        ...
        try:
            ...
            if not questionnaire_data:
                ...
                analysis_data = {
                    ...
                    "questionnaires": {q_type: eval(resp) for q_type, resp in questionnaire_data},
                    "examinations": {e_type: eval(findings) for e_type, findings in examination_data} if examination_data else {},
                    "clinical": eval(clinical_data[0]) if clinical_data else {}
                }
...
def generate_ai_analysis(data):
    ...
    ## Clinical Assessment
    Based on the available information, this patient presents with {"multiple" if len(dental_concerns) > 1 else "limited"} dental concerns that require attention.
    ...
    4. {"Schedule follow-up appointments to address all identified issues." if dental_concerns else "Recommend regular check-ups and preventive care."}

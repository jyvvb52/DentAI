...
def clinical_interaction_page():
    ...
    with tabs[2]:
        ...
        st.info("Click the microphone button below to start recording the dental conversation between the doctor and patient. Click again to stop recording when done.")
